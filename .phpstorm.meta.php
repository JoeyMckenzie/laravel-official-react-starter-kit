...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/joeymckenzie/code/github.com/joeymckenzie/laravel-official-react-starter-kit/public/storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links./Users/joeymckenzie/code/github.com/joeymckenzie/laravel-official-react-starter-kit/public/storage','inertia.ssr.enabled','inertia.ssr.url','inertia.ensure_pages_exist',
...
'debugbar.debug_backtrace_limit','boost.enabled','boost.browser_logs_watcher','ide-helper.filename','ide-helper.models_filename',
...
'debugbar.queries.explain','boost.browser-logs','home','dashboard','profile.edit','profile.update','profile.destroy','password.edit',
'password.update','appearance.edit','register','register.store','login',
'login.store','password.request','password.email','password.reset','password.store',
'verification.notice','verification.verify','verification.send','password.confirm','password.confirm.store',
