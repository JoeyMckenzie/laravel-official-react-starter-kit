...
class Container_a6548f9079 extends _PHPStan_ac6dae9b0\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService062(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_a6548f9079 $container)
			{
	...
	public function createServiceContainer(): Container_a6548f9079
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'XDEBUG_HANDLER_SETTINGS' => '/private/var/folders/1g/dzt9k_gn65ncbj7pfrxq9pj80000gn/T/mqor0es5er3d9niMPBa|1|*|*|:/Users/jmckenzie/Library/Application Support/Herd/config/php/84/php.ini|3.4.0alpha2-dev',
