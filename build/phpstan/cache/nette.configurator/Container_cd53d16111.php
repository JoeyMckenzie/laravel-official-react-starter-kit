...
class Container_cd53d16111 extends _PHPStan_ce257d9ac\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService062(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_cd53d16111 $container)
			{
	...
	public function createServiceContainer(): Container_cd53d16111
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'XDEBUG_HANDLER_SETTINGS' => '/private/var/folders/1g/dzt9k_gn65ncbj7pfrxq9pj80000gn/T/qotsht4qp0jb1gBAhHW|1|*|*|:/Users/jmckenzie/Library/Application Support/Herd/config/php/84/php.ini|3.4.0alpha2-dev',
