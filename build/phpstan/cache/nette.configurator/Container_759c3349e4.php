...
class Container_759c3349e4 extends _PHPStan_ce257d9ac\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService062(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_759c3349e4 $container)
			{
	...
	public function createServiceContainer(): Container_759c3349e4
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'XDEBUG_HANDLER_SETTINGS' => '/private/var/folders/1g/dzt9k_gn65ncbj7pfrxq9pj80000gn/T/oeaaltt1g4j77eBOn9N|1|*|*|:/Users/jmckenzie/Library/Application Support/Herd/config/php/84/php.ini|3.4.0alpha2-dev',
