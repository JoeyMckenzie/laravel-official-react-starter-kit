...
class Container_6a5dabf56f extends _PHPStan_ac6dae9b0\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService062(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_6a5dabf56f $container)
			{
	...
	public function createServiceContainer(): Container_6a5dabf56f
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'XDEBUG_HANDLER_SETTINGS' => '/private/var/folders/1g/dzt9k_gn65ncbj7pfrxq9pj80000gn/T/4pa049shut6t2SeTsHr|1|*|*|:/Users/jmckenzie/Library/Application Support/Herd/config/php/84/php.ini|3.4.0alpha2-dev',
